...
//    }
    ...
    @PostMapping("/register")
    public String register(@ModelAttribute Customer customer, @ModelAttribute BankAccount bankAccount) {
        System.out.println("your are in registe post request");
        String error = "";
        if (customerService.createCustomer(customer).equals("")) {
            bankAccountService.createBankAccount(customer, bankAccount);
        }
        else {
